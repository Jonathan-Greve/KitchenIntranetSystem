...
namespace KitchenIntranetSystem.Controllers
{
    public class ExpensesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,BeerExpense,FoodExpense,ShoppingExpense")] Expenses expenses)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,BeerExpense,FoodExpense,ShoppingExpense")] Expenses expenses)
        {
            if (id != expenses.Id)
            {
                return NotFound();
